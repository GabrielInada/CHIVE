 ...
 *
 * Lives in `ui/` because it is an ownerless browser UI mechanic shared across
 * layers: the dataset workspace dialogs, `features/settings/settingsDialog.js`,
 * and `app/bindings/keyboardShortcuts.js` (which consumes
 * {@link isAnyDialogOpen}) all depend on it. Not in `utils/` because it holds
 * module state and touches the DOM.
 */
