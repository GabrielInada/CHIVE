 ...
 * live in `tooltip/content.js` (re-exported below so the public surface stays a
 * single import) and the categorical filter-action defs in
 * `tooltip/filterActions.js`. Highest-traffic helper in the viz layer, imported
 * by every chart.
 */
...
import {
	...
	CLOSE_CLASS,
	PINNED_CLASS,
} from './tooltip/classNames.js';
import { buildPinnedShell } from './tooltip/content.js';
...
export { buildCategoricalFilterActions } from './tooltip/filterActions.js';
