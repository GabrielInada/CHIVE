 ...
 * @returns {void}
 */
export function setupLineChartControlListeners(dataset, numericOptions, dateOptions, allOptions, writer) {
	void dateOptions;
	...
	setupTextInputListener('viz-input-line-title', 'customTitle', writer);
	setupSliderListener('viz-slider-line-stroke-width', 'strokeWidth', writer);

	setupColorInputListener('viz-input-line-color', 'color', CHART_COLORS.line, writer);
	setupColorInputListener('viz-input-line-ghost-color', 'ghostStrokeColor', LINE_CHART.defaultGhostStrokeColor, writer);
}
